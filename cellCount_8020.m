...
for i = 1:2
    for f = 1:2
        ...
        filename1 = ['220311_8020_1_cs' num2str(f) '_20X_' num2str(i) '_DAPI.tif'];
        ...
        %save('counts_8020_B2__.mat', 'neuron', 'NeuronLoc', 'astro', 'AstroLoc', 'maskNeu', 'maskAs', 'map2GR', 'dapiBW', 'dapiNoise')
        %%
        %GFAP
        ...
        for cell2 = 2: astro
            ...
            if length(find(one_1 == 1))>0.4*length(one_1)
                astro2 = astro2+1;
